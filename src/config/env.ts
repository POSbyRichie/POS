...
export function loadEnv(): AppConfig {
  ...
  return {
    ...
    appTitle: import.meta.env.VITE_APP_TITLE || 'Antigravity Enterprise POS',
    defaultStoreName: import.meta.env.VITE_DEFAULT_STORE_NAME || 'Antigravity Enterprise Store',
