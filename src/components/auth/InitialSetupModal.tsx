...
export const InitialSetupModal: React.FC<InitialSetupModalProps> = ({ onComplete }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-50 flex flex-col items-center justify-center p-4 sm:p-6 overflow-y-auto text-slate-900">
      <div className="w-full max-w-xl bg-white border border-slate-200 rounded-3xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        {/* Header */}
        <div className="p-6 bg-white border-b border-slate-100 flex items-center justify-between">
          <div className="flex items-center gap-3.5">
            <img
              ...
              className="w-12 h-12 rounded-xl object-contain shadow-md border border-slate-200 bg-slate-950 p-0.5 shrink-0"
            />
            <div>
              <div className="flex items-center gap-2">
                <h1 className="text-base font-extrabold text-slate-900 flex items-center gap-1">
                  <span>RichiePOS Installation Setup</span>
                </h1>
              ...
              <p className="text-xs text-slate-500 mt-0.5">
                Configure your business profile &amp; create administrator credentials
              </p>
            </div>
          </div>
        </div>
        ...
        {/* Step Indicator */}
        <div className="grid grid-cols-2 bg-slate-50 border-b border-slate-200 text-xs font-semibold">
          <div
          ...
          <form onSubmit={handleNextStep} className="p-6 space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 bg-white border border-slate-300 hover:border-slate-400 rounded-xl text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:border-amber-500 transition shadow-sm"
              />
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 bg-white border border-slate-300 hover:border-slate-400 rounded-xl text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:border-amber-500 transition font-mono shadow-sm"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 bg-white border border-slate-300 hover:border-slate-400 rounded-xl text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:border-amber-500 transition font-mono font-bold shadow-sm"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-3.5 py-2.5 bg-white border border-slate-300 hover:border-slate-400 rounded-xl text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:border-amber-500 transition shadow-sm"
                />
              </div>
            </div>
            ...
            <div className="pt-3 border-t border-slate-100 flex justify-end">
              <button
                type="submit"
                className="px-5 py-2.5 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white font-bold rounded-xl text-xs flex items-center gap-2 transition shadow-md shadow-amber-500/20 active:scale-95 cursor-pointer"
              >
          ...
          <form onSubmit={handleCompleteSetup} className="p-6 space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 bg-white border border-slate-300 hover:border-slate-400 rounded-xl text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:border-sky-500 transition shadow-sm"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 bg-white border border-slate-300 hover:border-slate-400 rounded-xl text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:border-sky-500 transition font-mono shadow-sm"
              />
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-10 py-2.5 bg-white border border-slate-300 hover:border-slate-400 rounded-xl text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:border-sky-500 transition font-mono tracking-widest shadow-sm"
                  />
                  <button
                    type="button"
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 bg-white border border-slate-300 hover:border-slate-400 rounded-xl text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:border-sky-500 transition font-mono tracking-widest shadow-sm"
                />
              </div>
            </div>
            ...
            <div className="pt-3 border-t border-slate-100 flex items-center justify-between">
              <button
                ...
                className="px-4 py-2 text-slate-500 hover:text-slate-900 text-xs font-semibold transition"
              >
                &larr; Back
              </button>
